...
if __name__ == "__main__":
    ...
    if os.path.isdir(SKELETON_PATH):
        ...
        output_dir = os.path.join(os.path.dirname(SKELETON_PATH), "Identificador_de_ramas")
    else:
        input_files = [SKELETON_PATH]
        output_dir = os.path.join(os.path.dirname(os.path.dirname(SKELETON_PATH)), "Identificador_de_ramas")
