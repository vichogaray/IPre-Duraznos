...
imagen = imread(
    r"C:\Users\vgara\Downloads\yojodido.png",
    as_gray=True
)
...
if __name__ == "__main__":
    ...
    im0 = cv2.imread(r"C:\Users\vgara\Downloads\yojodido.png")
    if im0 is None:
        raise FileNotFoundError("No se pudo leer yojodido.png. Revisa la ruta.")
